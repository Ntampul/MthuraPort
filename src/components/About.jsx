  ...
  return (
    <section className="page-section about" id="about">
      ...
      <div className="about__content">
        ...
        <p className='.about__description'> As a Junior Software Developer, I am an enthusiastic and mtted to honing my skills to deliver high-quality and efficient software applications.
